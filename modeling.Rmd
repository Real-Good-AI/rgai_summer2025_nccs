...
table(df.predictions$IN_CI)

quantile(df.predictions$REL_ERROR, probs = seq(0,1,0.1))
...
quantile(summary.stats$RMSE, probs = seq(0,1,0.1))

quantile(summary.stats$RMSE.norm.mean, probs = seq(0,1,0.1))
```
