...
year_values <- c(2010, 2012, 2014) # Download files from years in this list
...
download.file(url=core_dd_url, destfile="CORE-HRMN_dd.csv", method=curl)
...
download.file(url=harmonized_dd_url, destfile="CORE-HRMN_dd.csv", method=curl)
...
download.file(url=unified_bmf_url, destfile="CORE-HRMN_dd.csv", method=curl)