...
```{r, eval = TRUE}
per.year.df <- readRDS("MODEL/outlier_detection/full/per_year_DF.rds")
...
```
Descriptive: What are the types of nonprofits that get spikes versus dips (NTEE, geographic region, overall size)?
```{r}
